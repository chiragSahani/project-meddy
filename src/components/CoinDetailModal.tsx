        ...
        <div className="sticky top-0 bg-[#071421]/95 backdrop-blur-md border-b border-white/10 p-6 flex items-center justify-between">
          {loading ? (
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <h2 className="text-xl font-bold text-gray-900">{coinDetail.name}</h2>
                <p className="text-sm text-gray-500 uppercase">{coinDetail.symbol}</p>
              </div>
            </div>
          ) : (
            <h2 className="text-xl font-bold text-gray-900">Coin Details</h2>
          )}
          ...
          {loading ? (
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                <div className="border border-gray-100 p-4 rounded-lg">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-medium text-gray-600">Market Rank</span>
                  </div>
                ...
                <div className="border border-gray-100 p-4 rounded-lg col-span-2 sm:col-span-1">
                  <div className="flex items-center gap-2 mb-2">
                    <BarChart3 className="w-4 h-4 text-gray-600" />
                ...
                <div className="border border-gray-100 p-4 rounded-lg">
                  <span className="text-sm font-medium text-gray-600 block mb-2">24h High</span>
                  <p className="text-lg font-semibold text-gray-900">
                ...
                <div className="border border-gray-100 p-4 rounded-lg">
                  <span className="text-sm font-medium text-gray-600 block mb-2">24h Low</span>
                  <p className="text-lg font-semibold text-gray-900">
                ...
                <div className="border border-gray-100 p-4 rounded-lg">
                  <span className="text-sm font-medium text-gray-600 block mb-2">7d Change</span>
                  <p
                ...
                <div className="border border-gray-100 p-4 rounded-lg col-span-2 sm:col-span-1">
                  <span className="text-sm font-medium text-gray-600 block mb-2">30d Change</span>
                  <p
                    className={`text-lg font-semibold ${
              ...
              {coinDetail.description && (
                <div className="border border-gray-100 p-4 rounded-lg">
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">About {coinDetail.name}</h3>
                  <div
